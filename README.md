...
Если получится еще и интересное чтиво — хм, может быть и интерес у читателей появится. 

## Rust

![Rust](https://static.tildacdn.com/tild3862-3331-4237-a563-623231356330/scale_1200.png)
...
Rust ощущается как среднее между мета-языком, в котором настраиваешь компилятор, CoffeeScript, 
